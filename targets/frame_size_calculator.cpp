...
void udf::frame_size_calculator::do_print_node(udf::print_node *const node, int lvl) {
  // EMPTY
}
...
void udf::frame_size_calculator::do_alloc_node(udf::alloc_node *const node, int lvl) {
  // EMPTY
}
